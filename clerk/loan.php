  ...
  <body>	
	...
	<div class="services">
		...
		<form action="" method="post" name="loan" id="loan">
				<table width="843" border="1" id="newMember">
						<tr>	
								...
								<?php if ($totalRows_loans > 0) { // Show if recordset not empty ?>
										<?php do { ?>
											<tr>
												<td><?php echo $row_loans['t_id']; ?></td>
												<td scope="col">
												<?php if($row_loans['approved']==1){?>
												<span class="glyphicon glyphicon-ok"></span>
												<?php }?>
												</td>
												<td><?php echo $row_loans['id_no']; ?></td>
												<td><?php echo $row_loans['names']; ?></td>
												<td style="color:#F00"><?php 
												$request=($row_loans['request_amound']+$row_loans['add_more']);
												echo $request; 
												?></td>
												<td><?php echo $row_loans['req_reason']; ?></td>
												<td><?php echo $row_loans['request_date']; ?></td>
												<td><?php echo $row_loans['payed']; ?></td>
												<td style="color:#F00"><?php echo $row_loans['request_amound'];?></td>
												<th scope="col" style="color:black"><?php echo $row_loans['award']; ?></th>
												
												<td scope="col"><?php echo $row_loans['penalty']; ?></td>
												<td>
		...
		<!--new members-->
			...
			<form action="<?php echo $editFormAction; ?>" method="POST" name="issue_loan" id="issue_loan">
					<table width="292" border="1" id="newMember">
							<caption>
									Loan Processing
									</caption>
							<tr>
							...
							<tr>
									...
									<td><label for="reason"></label>
											<textarea name="reason" id="reason" required></textarea></td>
							</tr>
							<tr>
							...
							<tr>
									...
									<td><label for="id_no"></label>
											<input name="id_no" type="text" id="id_no" value="<?php echo $row_getLoan['id_no']; ?>" readonly></td>
							</tr>
							<tr>
									<th scope="row"><input name="t_id" type="text" value="<?php echo $row_getLoan['t_id']; ?>"></th>
