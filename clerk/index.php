...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "clerk_prof.php";
  ...
  if ($loginFoundUser) {
    ...
    $failed_login="Check your username or password";
  }
}
?>
<!DOCTYPE html>
  ...
  <body>	
	...
	<div class="services">
		<div class="container">
			...
			<div class="col-md-6">
			<h2 align="center">Clerk Login</h2>
        <div id="failed_login" style="color:#FFF;text-align:center;background-color:#CC333F"><?php echo $failed_login;?></div>
					<form action="<?php echo $loginFormAction; ?>" method="POST" name="clerk_login" id="clerk_login">
