...
$query_getMem = sprintf("SELECT * FROM membership_fee WHERE mem_idno = %s", GetSQLValueString($colname_getMem, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE `member_reg` SET access=%s WHERE id_no=%s",
					...
					<table width="424" border="1" align="center" id="newMember">
							...
							<tr>
									...
									<td width="155"><label for="names"></label>
											<input name="names" type="text" id="names" value="<?php echo $row_getMem['mem_fname']; ?>"></td>
							</tr>
							<tr>
									<td>id no</td>
									<td><label for="id_no"></label>
											<input name="id_no" type="text" id="id_no" value="<?php echo $row_getMem['mem_idno']; ?>"></td>
							</tr>
							<tr>
									<td>Action</td>
